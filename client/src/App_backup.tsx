        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-4">
              {/* Credit/Debit Card */}
              <div className="border-2 border-gray-200 rounded-lg p-4 hover:border-sky-500 cursor-pointer transition-colors">
              ...
              {/* Klarna */}
              <div className="border-2 border-gray-200 rounded-lg p-4 hover:border-pink-500 cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-pink-500 rounded text-white text-xs flex items-center justify-center font-bold">K</div>
                  <div>
                    <h4 className="font-semibold">Klarna</h4>
              ...
              {/* American Express */}
              <div className="border-2 border-gray-200 rounded-lg p-4 hover:border-green-500 cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-green-500 rounded text-white text-xs flex items-center justify-center font-bold">AE</div>
                  <div>
                    <h4 className="font-semibold">American Express</h4>
                    <p className="text-sm text-gray-600">Express checkout</p>
                  </div>
                </div>
              </div>

              {/* Cash Payment */}
              <div className="border-2 border-gray-200 rounded-lg p-4 hover:border-yellow-500 cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-yellow-500 rounded text-white text-xs flex items-center justify-center font-bold">💷</div>
                  <div>
                    <h4 className="font-semibold">Airport Cash Payment</h4>
                    <p className="text-sm text-gray-600">Pay at the airport counter</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="text-center bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6">
                ...
                <p className="text-xs text-gray-500 mt-1">Verified by Trustpilot</p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold">256-bit SSL Encryption</h4>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold">ATOL Protected</h4>
                    <p className="text-sm text-gray-600">Your booking is protected</p>
                  </div>
                </div>
              </div>
            </div>
...
function MainApp() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-emerald-50 flex items-center justify-center">
        <div className="max-w-md mx-auto bg-white rounded-2xl shadow-2xl p-8 text-center">
          ...
          <p className="text-2xl font-bold text-sky-600 mb-6">{bookingId}</p>
          <p className="text-sm text-gray-500 mb-8">
            A confirmation email has been sent to your registered email address.
          </p>
          <Button
            onClick={handleBackToHome}
            className="w-full bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white py-3 rounded-lg font-medium transition-all duration-200"
          >
            Book Another Flight
          </Button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-600 via-blue-700 to-emerald-600 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Million<span className="text-yellow-300">Flights</span>.eu
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-4">
              Premium European Flight Experiences
            </p>
          ...
          {/* Trust Indicators */}
          <div className="mt-12 flex justify-center items-center gap-8 text-white">
            <div className="flex items-center gap-2">
              <Shield className="h-6 w-6" />
              <span className="text-sm">ATOL Protected</span>
            </div>
            <div className="flex items-center gap-2">
              <Award className="h-6 w-6" />
              <span className="text-sm">4.8★ Rated</span>
            </div>
            <div className="flex items-center gap-2">
      ...
      {/* Features Section */}
      <section className="py-20 bg-gradient-to-br from-sky-50 via-blue-50 to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-6">
              Why Choose MillionFlights.eu?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience premium aviation services with our comprehensive booking platform, 
              trusted by thousands of European travelers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center transform hover:scale-105 transition-transform duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-sky-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6">
                <Plane className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Premium Fleet</h3>
              <p className="text-gray-600 leading-relaxed">
                Modern aircraft with enhanced comfort, safety features, and premium amenities for an exceptional flying experience.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Secure Booking</h3>
              <p className="text-gray-600 leading-relaxed">
                ATOL protected bookings with 256-bit SSL encryption, ensuring your personal and payment information stays secure.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Round-the-clock customer support with live chat, ensuring assistance whenever you need it during your journey.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-6">Customer Stories</h2>
            <p className="text-xl text-gray-600">
              Join thousands of satisfied travelers who trust MillionFlights.eu
            </p>
          </div>

          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-sky-50 to-blue-50 rounded-2xl p-8 text-center">
              <div className="flex justify-center mb-4">
                {[...Array(5)].map((_, i) => (
      ...
      <section className="py-20 bg-gradient-to-r from-sky-600 to-blue-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Discover Europe with MillionFlights.eu. Book your premium flight experience today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              onClick={() => setCurrentView('fleet')}
              className="bg-white text-sky-600 hover:bg-gray-100 px-8 py-4 text-lg font-semibold rounded-lg transition-colors duration-200"
            >
              Explore Our Fleet
            </Button>
            <Button
              onClick={() => setCurrentView('map')}
              className="border-2 border-white text-white hover:bg-white hover:text-sky-600 px-8 py-4 text-lg font-semibold rounded-lg transition-colors duration-200"
            >
              View Airport Map
            </Button>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Premium European flight experiences with unmatched service and comfort.
              </p>
              <p className="text-sm text-gray-500">A PAGroup company</p>
            </div>

            <div>
              <h4 className="text-lg font-semibold mb-4">Services</h4>
              <ul className="space-y-2 text-gray-400">
                <li><button onClick={() => setCurrentView('home')} className="hover:text-white transition-colors">Flight Booking</button></li>
                <li><button onClick={() => setCurrentView('fleet')} className="hover:text-white transition-colors">Fleet Information</button></li>
                <li><button onClick={() => setCurrentView('map')} className="hover:text-white transition-colors">Airport Map</button></li>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-yellow-400">
                  ...
                  <span className="text-sm">{ratingData?.rating || '4.8'}/5 Rating</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 MillionFlights.eu - A PAGroup company. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="bg-gradient-to-r from-sky-500 to-blue-600 p-2 rounded-lg group-hover:scale-105 transition-transform duration-200">
              <Plane className="h-6 w-6 text-white" />
            </div>
            <div>
              <span className="text-2xl font-bold text-gray-800">MillionFlights.eu</span>
              <div className="text-xs text-gray-500 -mt-1">A PAGroup company</div>
            </div>
          </button>
          ...
          <div className="md:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
            <div className="flex flex-col space-y-3">
              <button
                ...
                className="text-left text-gray-700 hover:text-sky-600 font-medium transition-colors duration-200 py-2"
              >
                Fleet
              </button>
              <button
              ...
              {isAuthenticated ? (
                <div className="pt-2 border-t border-gray-200">
                  <p className="text-gray-700 py-2">Welcome, {user?.firstName}</p>
                  <Button
                    onClick={() => {
                      logout();
                      setIsMobileMenuOpen(false);
